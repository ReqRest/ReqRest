namespace ReqRest
{
    ...
    public sealed class ApiRequest<T1, T2, T3, T4, T5> : ApiRequestBase
    {
        ...
        public ApiRequest<T1, T2, T3, T4, T5, byte[]> ReceiveByteArray(params StatusCodeRange[] forStatusCodes) =>
        ...
        ///     <paramref name="forStatusCodes"/> is empty.
        /// </exception>
        public ApiRequest<T1, T2, T3, T4, T5, byte[]> ReceiveByteArray(IEnumerable<StatusCodeRange> forStatusCodes) =>
        ...
        public ApiRequest<T1, T2, T3, T4, T5, string> ReceiveString(params StatusCodeRange[] forStatusCodes) =>
        ...
        ///     <paramref name="forStatusCodes"/> is empty.
        /// </exception>
        public ApiRequest<T1, T2, T3, T4, T5, string> ReceiveString(IEnumerable<StatusCodeRange> forStatusCodes) =>
        ...
        ///     
        ///     The resource is represented through a <see cref="Variant{T1, T2, T3, T4, T5}"/>
        ...
        /// </example>
        [DebuggerStepThrough]
        public async Task<(ApiResponse<T1, T2, T3, T4, T5> Response, Variant<T1, T2, T3, T4, T5> Resource)> FetchAsync(
        ...
        ///     <see cref="ApiResponse{T1, T2, T3, T4, T5}.DeserializeResourceAsync"/> method
        ///     of the response.
        ///     
