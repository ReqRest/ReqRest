namespace ReqRest
{
    ...
    public sealed class ApiRequest<T1, T2, T3, T4, T5, T6, T7, T8> : ApiRequestBase
    {
        ...
        ///     
        ///     The resource is represented through a <see cref="Variant{T1, T2, T3, T4, T5, T6, T7, T8}"/>
        ...
        /// </example>
        [DebuggerStepThrough]
        public async Task<(ApiResponse<T1, T2, T3, T4, T5, T6, T7, T8> Response, Variant<T1, T2, T3, T4, T5, T6, T7, T8> Resource)> FetchAsync(
        ...
        ///     <see cref="ApiResponse{T1, T2, T3, T4, T5, T6, T7, T8}.DeserializeResourceAsync"/> method
        ///     of the response.
        ///     
