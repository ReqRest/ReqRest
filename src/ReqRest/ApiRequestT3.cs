namespace ReqRest
{
    ...
    public sealed class ApiRequest<T1, T2, T3> : ApiRequestBase
    {
        ...
        ///     
        ///     The resource is represented through a <see cref="Variant{T1, T2, T3}"/>
        ...
        /// </example>
        [DebuggerStepThrough]
        public async Task<(ApiResponse<T1, T2, T3> Response, Variant<T1, T2, T3> Resource)> FetchAsync(
        ...
        ///     <see cref="ApiResponse{T1, T2, T3}.DeserializeResourceAsync"/> method
        ///     of the response.
        ///     
        ...
        /// </param>
        /// <returns>
        ///     The deserialized resource represented through a <see cref="Variant{T1, T2, T3}"/>
        ///     which holds a value that matches the response type declared for the response's HTTP status code.
        ///     This variant is empty if the response's HTTP status code doesn't match any declared one.
        /// </returns>
        /// <exception cref="TaskCanceledException">
