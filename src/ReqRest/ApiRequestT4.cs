namespace ReqRest
{
    ...
    public sealed class ApiRequest<T1, T2, T3, T4> : ApiRequestBase
    {
        ...
        public ApiRequest<T1, T2, T3, T4, byte[]> ReceiveByteArray(params StatusCodeRange[] forStatusCodes) =>
        ...
        ///     <paramref name="forStatusCodes"/> is empty.
        /// </exception>
        public ApiRequest<T1, T2, T3, T4, byte[]> ReceiveByteArray(IEnumerable<StatusCodeRange> forStatusCodes) =>
        ...
        public ApiRequest<T1, T2, T3, T4, string> ReceiveString(params StatusCodeRange[] forStatusCodes) =>
        ...
        ///     <paramref name="forStatusCodes"/> is empty.
        /// </exception>
        public ApiRequest<T1, T2, T3, T4, string> ReceiveString(IEnumerable<StatusCodeRange> forStatusCodes) =>
        ...
        ///     
        ///     The resource is represented through a <see cref="Variant{T1, T2, T3, T4}"/>
        ...
        /// </example>
        [DebuggerStepThrough]
        public async Task<(ApiResponse<T1, T2, T3, T4> Response, Variant<T1, T2, T3, T4> Resource)> FetchAsync(
        ...
        ///     <see cref="ApiResponse{T1, T2, T3, T4}.DeserializeResourceAsync"/> method
        ///     of the response.
        ///     
        ...
        /// </param>
        /// <returns>
        ///     The deserialized resource represented through a <see cref="Variant{T1, T2, T3, T4}"/>
        ///     which holds a value that matches the response type declared for the response's HTTP status code.
        ///     This variant is empty if the response's HTTP status code doesn't match any declared one.
        /// </returns>
        /// <exception cref="TaskCanceledException">
