namespace DemoApplication.Api
{
    ...
    public class JsonPlaceholderClient : ApiClient
    {
        ...
        private static readonly ApiClientConfiguration DefaultConfig = new ApiClientConfiguration
        {
        ...
        //
        // When creating an interface, you must always pass an ApiClient instance.
        // The interfaces require it, because this way, they get access to the config (and things
        // like the HttpClient).
        // 
        // It is recommended to always create new Instances here. An ApiInterface is lightweight
        ...
        // Checkout the TodosInterface for a fully commented ApiInterface implementation
        // with additional tips and tricks at the bottom of the file.
        public TodosInterface Todos() =>
            new TodosInterface(this);

        // Checkout the TodoInterface for a commented parametrized ApiInterface implementation.
